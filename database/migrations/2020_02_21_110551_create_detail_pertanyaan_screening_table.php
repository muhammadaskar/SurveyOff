...
class CreateDetailPertanyaanScreeningTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_pertanyaan_screening', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('detail_pertanyaan_screening');
    }
}
